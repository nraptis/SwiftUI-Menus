//
//  MagicalSexyCheckBoxViewModel+AnimationTwistApplyToAll.swift
//  Jiggle3
//
...
@Observable class MagicalSexyCheckBoxViewModelAnimationTwistApplyToAll: MagicalSexyCheckBoxViewModel {
    ...
    deinit {
        if ApplicationController.DEBUG_DEALLOCS {
            print("MagicalSexyCheckBoxViewModelAnimationTwistApplyToAll - Dealloc")
        }
    }
}
