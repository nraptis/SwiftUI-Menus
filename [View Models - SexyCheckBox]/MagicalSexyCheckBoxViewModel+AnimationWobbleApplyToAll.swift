//
//  MagicalSexyCheckBoxViewModel+AnimationWobbleApplyToAll.swift
//  Jiggle3
//
...
@Observable class MagicalSexyCheckBoxViewModelAnimationWobbleApplyToAll: MagicalSexyCheckBoxViewModel {
    ...
    deinit {
        if ApplicationController.DEBUG_DEALLOCS {
            print("MagicalSexyCheckBoxViewModelAnimationWobbleApplyToAll - Dealloc")
        }
    }
}
