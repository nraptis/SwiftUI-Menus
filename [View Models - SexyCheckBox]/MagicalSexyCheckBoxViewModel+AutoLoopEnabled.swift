//
//  MagicalSexyCheckBoxViewModel+AutoLoopEnabled.swift
//  Jiggle3
//
...
@Observable class MagicalSexyCheckBoxViewModelAutoLoopEnabled: MagicalSexyCheckBoxViewModel {
    ...
    deinit {
        if ApplicationController.DEBUG_DEALLOCS {
            print("MagicalSexyCheckBoxViewModelAutoLoopEnabled - Dealloc")
        }
    }
}
