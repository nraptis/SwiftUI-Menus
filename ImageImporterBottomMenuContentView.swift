//
//  ImageImporterBottomMenuContentView.swift
//  Jiggle3
//
...
class ImageImporterBottomMenuContentView: UIView, MenuPartWithRowsConforming {
    ...
    func getToolRow(at index: Int) -> ToolRow? {
        if let imageImportViewModel = ApplicationController.shared.imageImportViewModel {
            if index >= 0 && index < imageImportViewModel.rowsTop.count {
                return imageImportViewModel.rowsBottom[index]
            }
        }
        return nil
    }
    ...
    func setup(width: Int,
        ...
        if Device.isPad {
            ...
            rowSeparatorHeightTop = ToolInterfaceTheme.getBottomRowSeparatorHeightTop(orientation: ImageImportViewModel.orientation)
            rowSeparatorHeightBottom = ToolInterfaceTheme.getBottomRowSeparatorHeightBottom(orientation: ImageImportViewModel.orientation)
        }
