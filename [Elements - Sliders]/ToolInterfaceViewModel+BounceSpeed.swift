...
extension ToolInterfaceViewModel {
    ...
    @MainActor func getBounceSpeedSliderToolNode(widthCategory: ToolInterfaceElementSliderWidthCategory,
        ...
        */
        ...
        let viewModelBounceSpeed = MagicalSliderViewModelBounceSpeed(orientation: jiggleViewModel.orientation,
