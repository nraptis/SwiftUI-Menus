...
extension ToolInterfaceViewModel {
    ...
    @MainActor func getSwivelCameraTwistSliderToolNode(widthCategory: ToolInterfaceElementSliderWidthCategory,
        ...
        */
        ...
        let viewModelSwivelCameraTwist = MagicalSliderViewModelSwivelCameraTwist(orientation: jiggleViewModel.orientation,
