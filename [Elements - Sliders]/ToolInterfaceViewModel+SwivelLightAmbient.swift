...
extension ToolInterfaceViewModel {
    ...
    @MainActor func getSwivelLightAmbientSliderToolNode(widthCategory: ToolInterfaceElementSliderWidthCategory,
        ...
        */
        ...
        let viewModelSwivelLightAmbient = MagicalSliderViewModelSwivelLightAmbient(orientation: jiggleViewModel.orientation,
