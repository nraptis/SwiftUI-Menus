...
extension ToolInterfaceViewModel {
    ...
    @MainActor func getInflateAmountSliderToolNode(widthCategory: ToolInterfaceElementSliderWidthCategory,
        ...
        let viewModelInflateAmount = MagicalSliderViewModelInflateAmount(orientation: jiggleViewModel.orientation,
