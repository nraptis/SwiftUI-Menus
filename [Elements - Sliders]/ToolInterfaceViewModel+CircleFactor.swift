...
extension ToolInterfaceViewModel {
    ...
    @MainActor func getCircleFactorSliderToolNode(widthCategory: ToolInterfaceElementSliderWidthCategory,
        ...
        */
        ...
        let viewModelCircleFactor = MagicalSliderViewModelCircleFactor(orientation: jiggleViewModel.orientation,
