...
extension ToolInterfaceViewModel {
    ...
    @MainActor func getSwivelCameraZoomSliderToolNode(widthCategory: ToolInterfaceElementSliderWidthCategory,
        ...
        */
        ...
        let viewModelSwivelCameraZoom = MagicalSliderViewModelSwivelCameraZoom(orientation: jiggleViewModel.orientation,
