...
extension ToolInterfaceViewModel {
    ...
    @MainActor func getSwivelCameraPanSliderToolNode(widthCategory: ToolInterfaceElementSliderWidthCategory,
        ...
        */
        ...
        let viewModelSwivelCameraPan = MagicalSliderViewModelSwivelCameraPan(orientation: jiggleViewModel.orientation,
