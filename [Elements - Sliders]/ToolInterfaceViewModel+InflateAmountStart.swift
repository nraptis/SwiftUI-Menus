...
extension ToolInterfaceViewModel {
    ...
    @MainActor func getInflateAmountStartSliderToolNode(widthCategory: ToolInterfaceElementSliderWidthCategory,
        ...
        */
        ...
        let viewModelInflateAmountStart = MagicalSliderViewModelInflateAmountStart(orientation: jiggleViewModel.orientation,
