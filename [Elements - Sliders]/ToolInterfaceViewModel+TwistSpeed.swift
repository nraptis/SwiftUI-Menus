...
extension ToolInterfaceViewModel {
    ...
    @MainActor func getTwistSpeedSliderToolNode(widthCategory: ToolInterfaceElementSliderWidthCategory,
        ...
        */
        ...
        let viewModelTwistSpeed = MagicalSliderViewModelTwistSpeed(orientation: jiggleViewModel.orientation,
