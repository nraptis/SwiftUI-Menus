...
extension ToolInterfaceViewModel {
    ...
    @MainActor func getMovementVerticalSliderToolNode(widthCategory: ToolInterfaceElementSliderWidthCategory,
        ...
        */
        ...
        let viewModelMovementVertical = MagicalSliderViewModelMovementVertical(orientation: jiggleViewModel.orientation,
