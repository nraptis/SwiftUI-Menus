...
extension ToolInterfaceViewModel {
    ...
    @MainActor func getSwivelCameraTiltSliderToolNode(widthCategory: ToolInterfaceElementSliderWidthCategory,
        ...
        */
        ...
        let viewModelSwivelCameraTilt = MagicalSliderViewModelSwivelCameraTilt(orientation: jiggleViewModel.orientation,
