...
extension ToolInterfaceViewModel {
    ...
    @MainActor func getSwivelLightDiffuseSliderToolNode(widthCategory: ToolInterfaceElementSliderWidthCategory,
        ...
        */
        ...
        let viewModelSwivelLightDiffuse = MagicalSliderViewModelSwivelLightDiffuse(orientation: jiggleViewModel.orientation,
