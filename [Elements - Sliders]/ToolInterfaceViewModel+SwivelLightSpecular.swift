...
extension ToolInterfaceViewModel {
    ...
    @MainActor func getSwivelLightSpecularSliderToolNode(widthCategory: ToolInterfaceElementSliderWidthCategory,
        ...
        */
        ...
        let viewModelSwivelLightSpecular = MagicalSliderViewModelSwivelLightSpecular(orientation: jiggleViewModel.orientation,
