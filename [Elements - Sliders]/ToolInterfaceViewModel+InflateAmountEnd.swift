...
extension ToolInterfaceViewModel {
    ...
    @MainActor func getInflateAmountEndSliderToolNode(widthCategory: ToolInterfaceElementSliderWidthCategory,
        ...
        */
        ...
        let viewModelInflateAmountEnd = MagicalSliderViewModelInflateAmountEnd(orientation: jiggleViewModel.orientation,
