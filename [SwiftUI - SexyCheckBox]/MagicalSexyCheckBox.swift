...
struct MagicalSexyCheckBox: View {
    ...
    func bodyContent() -> some View {
        ...
        let universalPaddingTop = SexyCheckBoxLayout.getUniversalPaddingTop(orientation: orientation,
                                                                              flavor: layoutSchemeFlavor,
                                                                              numberOfLines: numberOfLines)
        let universalPaddingBottom = SexyCheckBoxLayout.getUniversalPaddingBottom(orientation: orientation,
                                                                                    flavor: layoutSchemeFlavor,
                                                                                    numberOfLines: numberOfLines)
