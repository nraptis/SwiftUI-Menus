...
extension ToolInterfaceViewModel {
   ...
   @MainActor func getReverseMotionEnabledCheckBoxNode(neighborTypeLeft: ToolInterfaceElementType?,
        ...
        let viewModelReverseMotionEnabled = MagicalCheckBoxViewModelReverseMotionEnabled(orientation: jiggleViewModel.orientation,
