...
extension ToolInterfaceViewModel {
    ...
    @MainActor func getAlternateMotionEnabledCheckBoxNode(neighborTypeLeft: ToolInterfaceElementType?,
        ...
        let viewModelAlternateMotionEnabled = MagicalCheckBoxViewModelAlternateMotionEnabled(orientation: jiggleViewModel.orientation,
