...
extension ToolInterfaceViewModel {
    ...
    @MainActor func getHorizontalEnabledCheckBoxNode(neighborTypeLeft: ToolInterfaceElementType?,
        ...
        let viewModelHorizontalEnabled = MagicalCheckBoxViewModelHorizontalEnabled(orientation: jiggleViewModel.orientation,
