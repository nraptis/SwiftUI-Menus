...
extension ToolInterfaceViewModel {
   ...
   @MainActor func getOvershootEnabledCheckBoxNode(neighborTypeLeft: ToolInterfaceElementType?,
        ...
        let viewModelOvershootEnabled = MagicalCheckBoxViewModelOvershootEnabled(orientation: jiggleViewModel.orientation,
