...
extension ToolInterfaceViewModel {
   ...
   @MainActor func getSwivelPanLeftSexyButtonToolNode(neighborTypeLeft: ToolInterfaceElementType?,
        ...
        let viewModelSwivelPanLeft = MagicalSexyButtonViewModelSwivelPanLeft(orientation: jiggleViewModel.orientation,
                                                           sexyButtonConfiguration: configuration)
        let swivelPanLeftToolNode = ToolNode(id: getToolNodeID(),
                                    element: .sexyButtonSwivelPanLeft,
                                    flex: flex,
