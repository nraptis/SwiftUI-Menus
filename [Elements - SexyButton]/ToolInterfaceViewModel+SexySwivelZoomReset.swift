...
extension ToolInterfaceViewModel {
   ...
   @MainActor func getSwivelZoomResetSexyButtonToolNode(neighborTypeLeft: ToolInterfaceElementType?,
        ...
        let viewModelSwivelZoomReset = MagicalSexyButtonViewModelSwivelZoomReset(orientation: jiggleViewModel.orientation,
                                                           sexyButtonConfiguration: configuration)
        let swivelZoomResetToolNode = ToolNode(id: getToolNodeID(),
                                    element: .sexyButtonSwivelZoomReset,
                                    flex: flex,
