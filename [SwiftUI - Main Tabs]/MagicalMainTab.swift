...
struct MagicalMainTab: View {
    ...
    func bodyContent() -> some View {
        ...
        let outsideBoxPaddingTop = MainTabLayout.getOutsideBoxPaddingTop(orientation: orientation)
        let outsideBoxPaddingBottom = MainTabLayout.getOutsideBoxPaddingTop(orientation: orientation)
