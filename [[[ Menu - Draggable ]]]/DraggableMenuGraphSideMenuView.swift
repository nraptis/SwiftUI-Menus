//
//  DraggableMenuGraphSideMenuView.swift
//  Jiggle3
//
...
class DraggableMenuGraphSideMenuView: UIView, MenuPartWithRowsConforming {
    ...
    func setup(width: Int) {
        ...
        setupRows(width: width, offset: 0, rowHeight: rowHeight, rowSeparatorHeight: rowSeparatorHeight, reversed: true)
    }
}
