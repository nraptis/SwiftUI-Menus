...
class TopMenuVideoExportView: UIView, MenuPartWithRowsConforming {
    
    var separatorViews = [UIView]()
    var rowViews = [ToolRowView]()
    func getNumberOfRows() -> Int {
        ToolInterfaceTheme.getTopMenuVideoExportRowCount(orientation: toolInterfaceViewModel.orientation)
    }
