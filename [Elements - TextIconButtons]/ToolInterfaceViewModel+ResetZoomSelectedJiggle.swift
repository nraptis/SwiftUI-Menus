...
extension ToolInterfaceViewModel {
    ...
    func getResetZoomSelectedJiggleTextIconButtonToolNode(neighborTypeLeft: ToolInterfaceElementType?,
        ...
        let viewModelResetZoomSelectedJiggle = MagicalTextIconButtonViewModelResetZoomSelectedJiggle(orientation: jiggleViewModel.orientation,
                                                                                                     textIconButtonConfiguration: configuration)
        let resetZoomSelectedJiggleToolNode = ToolNode(id: getToolNodeID(), 
                                                       element: .textIconButtonResetZoomSelectedJiggle,
                                                       flex: flex,
                                                       magicalViewModel: viewModelResetZoomSelectedJiggle,
                                                       neighborTypeLeft: neighborTypeLeft,
                                                       neighborTypeRight: neighborTypeRight)
