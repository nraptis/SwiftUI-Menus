...
extension ToolInterfaceViewModel {
    ...
    func getRemoveWeightRingPointTextIconButtonToolNode(neighborTypeLeft: ToolInterfaceElementType?,
        ...
        let viewModelRemoveWeightRingPoint = MagicalTextIconButtonViewModelRemoveWeightRingPoint(orientation: jiggleViewModel.orientation,
                                                                                                 textIconButtonConfiguration: configuration)
        let removeWeightRingPointToolNode = ToolNode(id: getToolNodeID(), 
                                                     element: .textIconButtonRemoveWeightRingPoint,
                                                     flex: flex,
                                                     magicalViewModel: viewModelRemoveWeightRingPoint,
                                                     neighborTypeLeft: neighborTypeLeft,
                                                     neighborTypeRight: neighborTypeRight)
