...
extension ToolInterfaceViewModel {
    ...
    func getSelectPreviousJiggleTextIconButtonToolNode(neighborTypeLeft: ToolInterfaceElementType?,
        ...
        let viewModelSelectPreviousJiggle = MagicalTextIconButtonViewModelSelectPreviousJiggle(orientation: jiggleViewModel.orientation,
                                                                                               textIconButtonConfiguration: configuration)
        let selectPreviousJiggleToolNode = ToolNode(id: getToolNodeID(), 
                                                    element: .textIconButtonSelectPreviousJiggle,
                                                    flex: flex,
