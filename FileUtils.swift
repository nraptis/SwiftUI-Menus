...
final class FileUtils {
    ...
    nonisolated(unsafe) static let shared = FileUtils()
    ...
    lazy var savedJigglesDirectory: String = {
        var result = documentDirectory
        result += "saved_jiggles/"
        return result
    }()
    ...
    func getSavedJigglesFilePath(fileName: String?) -> String {
        var result = savedJigglesDirectory
        if let fileName = fileName {
            result = result + fileName
        }
        return result
